...
namespace JsoMvc.Controllers
{
    public class OfficersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OfficerId,Name,Rank,DOH")] Officer officer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OfficerId,Name,Rank,DOH")] Officer officer)
        {
            if (ModelState.IsValid)
            {
